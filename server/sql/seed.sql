...
INSERT INTO services (title, summary, detail, price, sortOrder) VALUES
('Performance Tuning', 'Dyno-backed calibration for European engines, naturally aspirated or turbocharged.', 'Custom maps developed on the dyno rather than off-the-shelf flashes. Covers stage 1 through to fully built engines, including boost control, fuelling and safety limits tuned for Australian fuel and climate.', 'From $890', 1),
('Engine Building', 'Full rebuilds, from a routine refresh to high compression race specification.', 'Complete teardown, measurement and reassembly with documented clearances. Forged internals, head work, balancing and dyno run-in available. Every build is photographed and handed over with a written specification sheet.', 'Quoted per build', 2),
('Restoration', 'Sympathetic restorations and modernised resto-mod builds for 80s and 90s European cars.', 'Rust repair, panel and paint coordination, interior retrim and mechanical overhaul. We work to an agreed scope and photograph every stage so you can see exactly where the budget went.', 'Quoted per project', 3),
('Diagnostics and Servicing', 'Logbook servicing and fault finding with manufacturer level scan tools.', 'Routine servicing that protects your warranty, plus deep diagnostic work on electrical faults, running problems and intermittent issues that generic scanners cannot see.', 'From $220', 4),
('Custom Fabrication', 'One-off intakes, exhausts, mounts and roll cages made in house.', 'TIG welded stainless and alloy fabrication for parts that do not exist off the shelf. Roll cages, turbo manifolds, intercooler piping, subframe reinforcement and custom mounting solutions.', 'From $450', 5),
('Parts Sourcing', 'Hard to find OEM, NOS and performance parts sourced through a global network.', 'Years of contacts across Europe, Japan and the US mean we can usually find the part that everyone else says is discontinued. We also carry rotating stock, listed in the marketplace.', 'Fee from $95', 6);
...
INSERT INTO wanted (title, make, postedBy, isStaff, contact, budget, description, status, createdAt) VALUES
('BMW E30 M-Technic II Front Bumper', 'BMW', 'Outlier Autowerke', 1, 'hello@outlierautowerke.example', 'Up to $1,200', 'Chasing a genuine M-Tech II front bumper for a customer build. Original preferred but a good quality reproduction will be considered. Cracks and tabs are fine, we can repair. Happy to arrange freight.', 'open', '2026-08-02'),
('Porsche 944 Turbo Front Calipers', 'Porsche', 'Daniel R.', 0, 'Via site enquiry', '$800 to $1,500', 'Looking for a pair of front calipers from a 951 Turbo S. Seized is fine as long as the bodies are not cracked or heavily corroded, as I can rebuild them myself.', 'open', '2026-07-29'),
('15 inch Steel Wheels for Rally Use', 'Volkswagen', 'Priya M.', 0, 'Via site enquiry', 'Up to $400 the set', 'After a set of four, ideally six, 15 inch steel wheels in 5x100 for a gravel car. Rust and ugly paint are not an issue but they need to be straight and not buckled.', 'open', '2026-07-24'),
('Individual Throttle Body Assembly', 'BMW', 'Outlier Autowerke', 1, 'hello@outlierautowerke.example', 'Market rate', 'Need a complete throttle body assembly including the actuator for a customer conversion. Would also consider a full engine if the price is right and the rest is serviceable.', 'fulfilled', '2026-07-16');

INSERT INTO exchanges (title, make, postedBy, isStaff, contact, offering, wanting, description, status, createdAt) VALUES
('OBD1 ECU, swap for OBD2', 'BMW', 'Outlier Autowerke', 1, 'hello@outlierautowerke.example', 'OBD1 engine control unit, tested and working, removed from a running car', 'Equivalent OBD2 unit, or a set of E36 M3 front control arms', 'Ended up with the wrong variant after an engine swap. Straight swap preferred, happy to add cash either way depending on condition.', 'open', '2026-08-05'),
('17 inch wheels, trade for 18 inch', 'Audi', 'Marcus L.', 0, 'Via site enquiry', 'Genuine 17x7.5 5x112 wheels, four of them, no damage, tyres at 60 percent', 'Genuine 18 inch in the same pattern, any style considered', 'The car sits better on 18s. Wheels are straight with no kerb rash worth mentioning. Happy to travel a couple of hours to swap in person.', 'open', '2026-07-31'),
('Turbo manifold, swap for intercooler', 'Volkswagen', 'Outlier Autowerke', 1, 'hello@outlierautowerke.example', 'Cast 1.8T turbo manifold, crack tested and clean', 'Front mount intercooler kit suitable for a Mk4 platform', 'Surplus to requirements after a customer changed direction mid build. Would consider other forced induction hardware of similar value.', 'open', '2026-07-20');
